...
def generate_launch_description():
    ...
    go2_lidar_localization_node = Node(
        package="go2_sdk",
    ...
    return LaunchDescription(
        [
            ...
            # Lauch LiDAR TF first
            lidar_tf_node,

            # Delay rest of nodes to ensure TF is available
            TimerAction(
                period=1.0,
                actions=[
                    ...
                    robot_state_node,
                    joint_state_node,
                    # TF between utlidar/robot_pose and base_link
                    pose_to_tf_node,
                    # Go2 control nodes
                    cmd_vel_to_go2_node,
